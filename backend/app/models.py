...
# Compute engine catalog. Declared here rather than in app.engines because the
# schema layer must not import the driver layer (app.engines imports this module
# for InstanceStatus); app/engines/__init__.py asserts the two stay in sync.
KNOWN_ENGINES = ("qemu",)
DEFAULT_ENGINE = "qemu"
