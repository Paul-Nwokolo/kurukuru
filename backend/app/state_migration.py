...
from app.engines.ports import is_port_free
from app.engines.process import pid_alive
...
def migrate_state_dir(
    ...
    * **A database backup is taken first**, using the machinery Phase 14 built
    ...
    """
    from app.database import _engine_file, backup_database_file  # circular at module scope
