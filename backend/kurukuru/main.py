...
def _warn_if_no_account() -> None:
    ...
    from kurukuru.database import engine
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    from kurukuru.routers.images import ensure_builtin_image
    ...
    from kurukuru.routers.projects import ensure_default_project
    ...
    from kurukuru.routers.networks import ensure_default_network
    ...
    from kurukuru.events import prune_events
...
app = FastAPI(
    ...
    # deliberate edit to kurukuru.security.PUBLIC_ROUTES that a reviewer will see.
...
def host_capacity(
    ...
    """
    from kurukuru.host_capacity import get_capacity
    ...
    try:
        ...
        from kurukuru.engines.qemu import HARDWARE_ACCELS
...
def list_boot_isos(
    ...
    """
    from kurukuru.isos import list_isos
...
from kurukuru.routers import (  # noqa: E402
    auth as auth_routes,
