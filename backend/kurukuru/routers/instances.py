...
from kurukuru.cloud_init import CloudInitError, build_cloud_init
from kurukuru.cloud_init import cleanup as cleanup_cloud_init
from kurukuru.config import Settings, get_settings
from kurukuru.console import (
    CLOSE_CONFLICT,
    CLOSE_NOT_FOUND,
...
from kurukuru.host_capacity import HostCapacity, get_capacity, invalidate_cache
from kurukuru.image_store import image_path
from kurukuru.isos import IsoError, resolve_iso
...
from kurukuru.routers.keypairs import orchestrator_keypair
from kurukuru.routers.projects import project_filter, resolve_project_id
from kurukuru.user_data import UserDataError, parse_user_data
...
def _resolve_network_id(session: Session, network_id: str | None) -> str | None:
    ...
    """
    from kurukuru.models import Network
    from kurukuru.routers.networks import default_network
...
def delete_instance(
    ...
    with _api_operation(instance.id):
        ...
        from kurukuru.routers.snapshots import delete_snapshots_for_instance
        ...
        from kurukuru.routers.volumes import detach_volumes_for_instance
        ...
        from kurukuru.routers.networks import delete_forwards_for_instance
