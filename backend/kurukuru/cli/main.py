...
back door. Every command here goes through :mod:`kurukuru.cli.client`; nothing
...
if __name__ == "__main__":  # pragma: no cover - `python -m kurukuru.cli.main`
    main()
